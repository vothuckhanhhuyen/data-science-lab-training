...
def gen_data_and_vocab():
    ...
    vocab.sort()
    with open('C:\\Users\\ASUS\\PycharmProjects\\DSLABtraining\\20news-bydate\\vocab-raw.txt', 'w') as f:
        f.write('\n'.join(vocab))
    ...
    with open('C:\\Users\\ASUS\\PycharmProjects\\DSLABtraining\\20news-bydate\\20news-train-raw.txt', 'w') as f:
        f.write('\n'.join(train_data))

    with open('C:\\Users\\ASUS\\PycharmProjects\\DSLABtraining\\20news-bydate\\20news-test-raw.txt', 'w') as f:
        f.write('\n'.join(test_data))
